...
///  };
/// var popup = new gebetagl.Popup({offset: popupOffsets, className: 'my-class'})
///   .setLngLat(e.lngLat)
...
class PopupJsImpl extends EventedJsImpl {
  ...
  ///
  /// @example
  /// var popup = new gebetagl.Popup().addTo(map);
  /// popup.remove();
  /// @returns {Popup} `this`
