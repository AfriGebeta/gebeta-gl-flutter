...
import 'package:gebeta_gl_web/src/interop/ui/map_interop.dart';
import 'package:gebeta_gl_web/src/interop/ui/popup_interop.dart';
import 'package:gebeta_gl_web/src/interop/util/evented_interop.dart';
...
class MarkerJsImpl extends EventedJsImpl {
  ...
  ///  @example
  ///  var marker = new gebetagl.Marker().addTo(map);
  ///  marker.remove();
  ///  @returns {Marker} `this`
