...
import 'package:gebeta_gl_web/src/interop/style/evaluation_parameters_interop.dart';
import 'package:gebeta_gl_web/src/interop/style/style_image_interop.dart';
...
abstract class StyleJsImpl extends EventedJsImpl {
  ...
  ///
  ///  May throw an Error ('Unimplemented: METHOD') if the gebeta-gl-style-spec
