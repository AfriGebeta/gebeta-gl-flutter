...
///  @example
///  var sw = new gebetagl.LngLat(-73.9876, 40.7661);
///  var ne = new gebetagl.LngLat(-73.9397, 40.8002);
///  var llb = new gebetagl.LngLatBounds(sw, ne);
class LngLatBounds extends JsObjectWrapper<LngLatBoundsJsImpl> {
  ...
  ///  @example
  ///  var llb = new gebetagl.LngLatBounds([-73.9876, 40.7661], [-73.9397, 40.8002]);
  ...
  ///  var llb = gebetagl.LngLatBounds.convert(arr);
