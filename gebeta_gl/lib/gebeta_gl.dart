...
///
/// To display a map, add a [GebetaMap] widget to the widget tree.
///
/// In this plugin, the map is configured through the parameters passed to the [GebetaMap] constructor and through the [GebetaMapController].
/// The [GebetaMapController] is provided at runtime by the [GebetaMap.onMapCreated] callback.
...
/// [styleString] parameter of the [GebetaMap] constructor.
...
export 'package:gebeta_gl_platform_interface/maplibre_gl_platform_interface.dart'
    show
        Annotation,
        ArgumentCallbacks,
