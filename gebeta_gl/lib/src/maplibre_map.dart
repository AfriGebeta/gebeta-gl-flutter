...
/// Also refer to the documentation of [gebeta_gl] and [GebetaMapController].
class GebetaMap extends StatefulWidget {
  const GebetaMap({
    super.key,
  ...
  ///
  /// If this is set to true and the user pans/zooms/rotates the map, [GebetaMapController] (which is a [ChangeNotifier])
  /// will notify it's listeners and you can then get the new [GebetaMapController].cameraPosition.
  ...
  @override
  State createState() => _GebetaMapState();
}

class _GebetaMapState extends State<GebetaMap> {
