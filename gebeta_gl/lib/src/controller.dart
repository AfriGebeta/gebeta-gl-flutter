...
typedef MaplibreMapController = GebetaMapController;

/// Controller for a single [GebetaMap] instance running on the host platform.
///
...
/// For more information about MapLibre Styles, see the documentation of [gebeta_gl] as well as the specification at [https://maplibre.org/maplibre-style-spec/].
///
/// A MapLibreMapController is also a [ChangeNotifier]. Subscribers (change listeners) are notified upon changes to any of
///
/// * the configuration options of the [GebetaMap] widget
...
class GebetaMapController extends ChangeNotifier {
  GebetaMapController({
  ...
  /// Will be null, if [GebetaMap.trackCameraPosition] is false.
  ...
  /// id of the feature. This is useful because by default gebeta-gl-js does not
  /// support string ids
  ///
  /// The returned [Future] completes after the change has been made on the
  /// platform side.
